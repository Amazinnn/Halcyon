...
export interface FakeTrack {
  ...
  genre: string;
  durationMs: number;
  cover: string; // gradient key g1..g3
}

export const FAKE_PLAYLIST: FakeTrack[] = [
  { id: "t1", title: "Midnight Focus", artist: "Focus Ensemble", album: "Deep Work", genre: "纯音乐", durationMs: 246_000, cover: "g1" },
  { id: "t2", title: "Rainy Window", artist: "Ambient Lab", album: "Study Rain", genre: "白噪音", durationMs: 312_000, cover: "g2" },
  { id: "t3", title: "Neon Circuit", artist: "Pixel Waves", album: "Night Drive", genre: "电子", durationMs: 198_000, cover: "g3" },
];
