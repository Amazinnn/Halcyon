...
> 更新：2026-08-08（v1.10.3 修复轮已实现待验收：#42–#46；ADR-0015/0016；前序 v1.10/v1.10.1/v1.10.2 已实现待验收）。新对话请先读本页，再按需查阅 next-phase / requirements / ADR。
...
## 当前版本与已验证清单（v1.10.3 + v1.9.1 + M4 v1 + v1.10 + v1.10.1 + v1.10.2 已实现待验收）
