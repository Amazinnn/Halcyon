...
> 更新：2026-08-07（v1.9.1）。新对话请先读本页，再按需查阅 next-phase / requirements / ADR。
...
- M4：内置工作流引擎（精简 n8n）——2026-08-07 已讨论方向（#26）：步骤列表编辑器 / 仅 Focus 内部节点 / 手动+事件+定时 / 新浮窗 / agent 发完即走 / 专注结束+监督告警 / 3 模板 / 条件守卫；**未实施**。
